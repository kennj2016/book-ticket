...
import {Form,Input,Button,message,Col,Row,Alert,Radio,Modal,InputNumber,Checkbox} from 'antd';
import braintree from 'braintree-web';
import {addCard,getPaymentToken,setCardBooking,getCards} from '../../../actions/paymentActions'
import {changeCardBooking} from '../../../actions/bookActions'
...
class UpdateCard extends Component {
    ...
    showConfirm = (card_id)=>{
        ...
        confirm({
            title: 'Do you want to change card for this booking?',
            content: '',
            onOk: () => {
                changeCardBooking(this.props.booking._id,card_id).then(res=>{
                    this.setState({
                        cardBooking:this.props.cards.find(card=>card._id == card_id)
                    })
                }).catch(err=>{
            ...
            <Row>
                <Col xs={24} sm={12} md={12} lg={12} xl={12}>
                    ...
                    {this.props.cards.length > 0 && (
                        ...
                        <div>
                            <RadioGroup onChange={this.onChangeCardBooking} value={this.state.cardBooking._id}>
...
const WrappedUpdateCard = Form.create()(UpdateCard);
export default connect(mapStateToProps, {setCardBooking,getCards})(WrappedUpdateCard)
