...
import {ProcessStep,NavigateMobile} from './ProcessStep'
const {Header} = Layout
    ...
    render() {
        ...
        if(this.props.isAuthenticated){
            ...
            ListPhotoseshType = this.props.photoseshTypeList.map((phototype, i)=> {
                ...
                return (
                    <Col xs={12} sm={12} md={12} lg={12} xl={12} key={i}  style={{paddingTop:30}}>
            ...
            ListPhotoseshType = PhotoseshTypeList.map((phototype, i)=> {
                ...
                return (
                    <Col xs={12} sm={12} md={12} lg={12} xl={12} key={i}  style={{paddingTop:80}}>
                        <Card
